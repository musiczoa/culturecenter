...
<%@page import="com.kitri.board.model.QnaDto"%>
<%@ page language="java" contentType="text/html; charset=EUC-KR"
	pageEncoding="EUC-KR" %>
<%@ include file="/common/bcommon.jsp" %>
<%
	List<QnaDto> list = (List<QnaDto>)request.getAttribute("listArticle");
...
%>
			...
			href="javascript:goMyList('<%=memberDto.getId()%>');"><img
