					...
					<table>
						...
						<tr>
							<td align="center">
								<table>
									<tr>
										<td><a href="<%=root %>/community/notice.jsp">공지사항</a></td>
									</tr>
										<td><a href="<%=root %>/community/review/review.jsp">공연후기</a></td>
									</tr>
									<tr>
							...
							<td align="center">
								...
								<p align="right">
									<input type="button" value="글쓰기" onclick="document.location.href='./hugiwrite.jsp';">
								</p>
							</td>
						</tr>
					</table>
