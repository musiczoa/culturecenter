...
List<ReboardDto> list = (List<ReboardDto>)request.getAttribute("listArticle");
			...
			<td align="Left"><%@ include file="/board/BoardLeftMenu.jsp"%>
				...
				<td align="center">
					<table width="800" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td><br><br><br><br><br><img src="<%=root%>/img/board/m_icon_board.gif" width="9"
					...
					if(size!=0){
						...
						<tr>
							...
							<td style="word-break: break-all;"><a href="javascript:;"
								onClick="showSideView();" class="link_board_04"><%= reboardDto.getNickname()%></a></td>
							<td></td>
					...
					<table width="800" cellpadding="0" cellspacing="0" border="0">
						...
						<tr valign="top">
							<td nowrap><a href="javascript:goWrite();"><img
								src="<%=root%>/img/board/btn_write_01.gif" width="64" height="22"
								border="0" align="absmiddle" alt="글쓰기"></a></td>
							<td width="100%" align="center"><!--PAGE--> <%=pageNavi.getNavigator() %></td>
					...
					%>
								...
								href="javascript:goMyList('<%=memberDto.getNickname()%>');"><img
