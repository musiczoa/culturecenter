...
<%@ page language="java" contentType="text/html; charset=EUC-KR"
  ...
  <table width = "800" >
	...
	<input type="text" name="word" value=""> <input type="submit" value="검색" onClick="javascript:perList();">
	</td>
	</form>  
	</tr>
  ...
  <tr>
   <td>  
               ...
               %>
				<tr>
					<td><a href="<%=root%>/perform?act=performInfo&seq=<%=cDto.getSeq()%>"><img src="<%=cDto.getSummary()%>" width="185" height="160"></a></td>
					<td>
					<table cellspacing="10">
						...
						<tr>
						<td><font size = "2" color="#a31aa6"><%=cDto.getS_time()%> ~ <%=cDto.getE_time()%></td>
						</tr>
						<tr>
