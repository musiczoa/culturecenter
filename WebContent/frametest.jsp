...
<input type="button" value="버튼" onclick="javascript:menu('<%=root %>/community/hugi.jsp');" />
<input type="button" value="버튼1" onclick="javascript:menu('<%=root %>/community/qna.jsp');" />
<iframe id="ifr" src="<%=root %>/community/qna.jsp" width="600" height="600"></iframe>
